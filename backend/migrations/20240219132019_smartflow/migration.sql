...
CREATE TABLE "UserRule" (
    ...
    CONSTRAINT "UserRule_pkey" PRIMARY KEY ("userId","ruleId")
);
...
-- AddForeignKey
ALTER TABLE "Notification" ADD CONSTRAINT "Notification_cardId_fkey" FOREIGN KEY ("cardId") REFERENCES "Card"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "UserRule" ADD CONSTRAINT "UserRule_ruleId_fkey" FOREIGN KEY ("ruleId") REFERENCES "Rule"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
